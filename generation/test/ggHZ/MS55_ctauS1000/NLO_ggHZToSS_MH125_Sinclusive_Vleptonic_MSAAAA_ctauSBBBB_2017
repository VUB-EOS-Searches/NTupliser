...
##
            '9000006:all = sk   skbar    0        0          0       55.0  1.9732e-16  1.0  75.0 1000',
            '9000006:oneChannel = 1  1.0 101  1 -1'
            '9000006:oneChannel = 1  1.0 101  2 -2',
            '9000006:oneChannel = 1  1.0 101  3 -3',
            '9000006:oneChannel = 1  1.0 101  4 -4',
            '9000006:oneChannel = 1  1.0 101  5 -5',
            '9000006:oneChannel = 1  1.0 101  11 -11',
            '9000006:oneChannel = 1  1.0 101  12 -12',
            '9000006:addChannel = 1  1.0 101  13 -13',
            '9000006:oneChannel = 1  1.0 101  14 -14',
            '9000006:addChannel = 1  1.0 101  15 -15',
            '9000006:oneChannel = 1  1.0 101  16 -16',
            '9000006:mayDecay = on',
